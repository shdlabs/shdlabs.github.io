...
{
	if (region.bS.aX === region.cf.aX)
	{
		return 'on line ' + region.bS.aX;
	}
	return 'on lines ' + region.bS.aX + ' through ' + region.cf.aX;
}
...
var $author$project$Elmstatic$PostList = F4(
	function (posts, section, siteTitle, title) {
		return {en: posts, cR: section, bq: siteTitle, aO: title};
	});
var $author$project$Elmstatic$Post = F8(
	function (content, date, format, link, section, siteTitle, tags, title) {
		return {cc: content, dH: date, cj: format, d9: link, cR: section, bq: siteTitle, eN: tags, aO: title};
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Elmstatic$stylesheet('//cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css'),
		...
		return $elm$browser$Browser$document(
			{
				...
				e4: F2(
					function (_v1, contentJson) {
						return _Utils_Tuple2(contentJson, $elm$core$Platform$Cmd$none);
					}),
				e6: function (contentJson) {
					var _v2 = A2($elm$json$Json$Decode$decodeValue, decoder, contentJson);
					if (_v2.$ === 1) {
						var error = _v2.a;
						return {
							bB: _List_fromArray(
						...
						if (_v3.$ === 1) {
							...
							return {
								bB: _List_fromArray(
									[
										A2($author$project$Elmstatic$htmlTemplate, content.bq, viewHtml)
									]),
								aO: ''
							};
						}
...
var $author$project$Page$footers = A2(
	$elm$html$Html$footer,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bd-footer p-3 p-md-5 mt-5 bg-light text-center text-sm-start')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('container-xxl navbar')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$alt('Gemonicko Art'),
							$elm$html$Html$Attributes$src('img/gemonickoLogo.svg'),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('bd-footer-links ps-0 mb-3')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('d-inline-block ms-3')
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('btn btn-bd-primary')
												]),
											_List_fromArray(
												[
...
var $author$project$Page$navbar = _List_fromArray(
	[
		A2(
		$elm$html$Html$header,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('navbar navbar-expand-md navbar-dark bd-navbar')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container-xxl flex-wrap flex-md-nowrap')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar-brand p-0 me-2'),
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$alt('Gemonicko Art'),
										$elm$html$Html$Attributes$src('img/gemonickoLogo.svg'),
										A2($elm$html$Html$Attributes$attribute, 'height', '70')
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar-nav me-2 mb-2 mb-lg-0')
							]),
						_List_fromArray(
							[
								A2(
		...
		return _Utils_ap(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('container-xxl my-md-4 bd-layout')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('bd-main order-1')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('bd-intro ps-lg-4')
										]),
									A2(
					...
					$author$project$Page$footers,
					$author$project$Elmstatic$stylesheet('styles.css'),
					$author$project$Elmstatic$script('//cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js')
				]));
	});
...
var $author$project$Post$tagsToHtml = function (tags) {
	...
	var linkify = function (tag) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('badge bg-gem rounded-pill'),
					$elm$html$Html$Attributes$href(
					tagLink(tag))
				]),
			_List_fromArray(
...
var $author$project$Elmstatic$Page = F4(
	function (content, format, siteTitle, title) {
		return {cc: content, cj: format, bq: siteTitle, aO: title};
	});
